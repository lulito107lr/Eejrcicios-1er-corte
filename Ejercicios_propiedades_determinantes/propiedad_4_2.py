...
def intercambiar_filas(matriz, fila1, fila2):
    nueva_matriz = matriz[:]
    nueva_matriz[fila1], nueva_matriz[fila2] = nueva_matriz[fila2], nueva_matriz[fila1]
    return nueva_matriz
...
def intercambiar_columnas(matriz, col1, col2):
    ...
    for fila in matriz:
        nueva_fila = fila[:]
        nueva_fila[col1], nueva_fila[col2] = nueva_fila[col2], nueva_fila[col1]
...
a11.setInitialValue(9)
a12.setInitialValue(0)
a13.setInitialValue(3)
a21.setInitialValue(-1)
a22.setInitialValue(4)
a23.setInitialValue(7)
a31.setInitialValue(2)
a32.setInitialValue(6)
...
# Intercambiamos columnas 0 y 2
matriz_columnas_intercambiadas = intercambiar_columnas(matriz_original, 1, 2)
det_columnas = determinante(matriz_columnas_intercambiadas)

# Mostramos resultados
print("Determinante original:", det_original)
print("Determinante tras intercambiar columnas 0 y 2:", det_columnas)
