...
# Intercambiamos filas 0 y 1
matriz_filas_intercambiadas = intercambiar_filas(matriz_original, 0, 1)
det_filas = determinante(matriz_filas_intercambiadas)


# Mostramos resultados
print("Determinante original:", det_original)
print("Determinante tras intercambiar filas 0 y 2:", det_filas)
